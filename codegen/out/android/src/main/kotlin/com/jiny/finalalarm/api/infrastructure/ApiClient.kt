...
import com.jiny.finalalarm.api.auth.HttpBearerAuth
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "com.jiny.finalalarm.api.baseUrl"
        @Deprecated(
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(BASE_URL_KEY, "/api/v1")
        }
    }
}
