...
import com.jiny.finalalarm.CHANNEL_UNLOCK_APPROVED
import com.jiny.finalalarm.CHANNEL_UNLOCK_REQUEST
import com.jiny.finalalarm.MainActivity
...
class FinalAlarmMessagingService : FirebaseMessagingService() {
    ...
    private fun showUnlockApprovedNotif(data: Map<String, String>) {
        ...
        val intent = Intent("com.jiny.finalalarm.UNLOCK_APPROVED").apply {
